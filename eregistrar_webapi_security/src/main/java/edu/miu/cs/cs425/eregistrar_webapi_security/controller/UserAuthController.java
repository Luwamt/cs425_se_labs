package edu.miu.cs.cs425.eregistrar_webapi_security.controller;

import edu.miu.cs.cs425.eregistrar_webapi_security.dto.UserAuthRequest;
import edu.miu.cs.cs425.eregistrar_webapi_security.util.JWTMgmtUtil;
...
@RestController
@RequestMapping(value = {"eregistrar/api/student/service"})
