...
public class Student {
    ...
    @Column(name="student_number", nullable = false)//store in database
...
//    @NotEmpty(message = "Student number can not empty or null")//""
    ...
    @NotNull(message = "CGPA can't be null")
    private Double cgpa;
   ...
   @DateTimeFormat(pattern = "yyyy-MM-dd")
    ...
    public Student(String studentNumber, String firstName, String middleName,
                   String lastName, Double cgpa, LocalDate dateOfEnrollment, String isInternational) {
